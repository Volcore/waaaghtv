 ...
 *******************************************************************************/
public class RelayPong implements WTVMessage
{
    static Logger   logger = LoggerFactory.getLogger( "RelayPong" );
    ...
    public RelayPong( int timestamp ) throws ParseException
    {
        this.timestamp = timestamp;
    }

    public RelayPong( IoBuffer in ) throws ParseException
    {
        timestamp = in.getInt( );
    }
    ...
    public IoBuffer assemble( )
    {
        try {
            ...
            buf.put( WTVMessageFactory.RELAY_PONG );
            buf.putShort( length );
