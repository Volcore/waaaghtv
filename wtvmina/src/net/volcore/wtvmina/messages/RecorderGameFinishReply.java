 ...
 *******************************************************************************/
public class RecorderGameFinishReply implements WTVMessage
{
    static Logger   logger = LoggerFactory.getLogger( "RecorderGameFinishReply" );
    ...
    public RecorderGameFinishReply( int gameId, int result )
    {
        this.gameId = gameId;
        this.result = result;
    }

    public RecorderGameFinishReply( IoBuffer in ) throws ParseException
    {
        try {
    ...
    public IoBuffer assemble( )
    {
        try {
            ...
            buf.put( WTVMessageFactory.RECORDER_GAMEFINISHREPLY );
            buf.putShort( length );
            buf.putInt( gameId );
            buf.putInt( result );
            buf.flip( );
    ...
    {
        return "("+this.getClass( ).getName( )+": "+gameId+" "+result+")";
    }
}
