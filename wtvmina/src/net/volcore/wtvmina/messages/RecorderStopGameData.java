 ...
 *******************************************************************************/
public class RecorderStopGameData implements WTVMessage
{
    static Logger   logger = LoggerFactory.getLogger( "RecorderStopGameData" );
    ...
    public RecorderStopGameData( int gameId, int forceDelete )
    {
        this.gameId = gameId;
        this.forceDelete = forceDelete;
    }

    public RecorderStopGameData( IoBuffer in ) throws ParseException
    {
        try {
            this.gameId = in.getInt( );
            this.forceDelete = in.getInt( );
        } catch( Exception e )
        {
            e.printStackTrace( );
    ...
    public IoBuffer assemble( )
    {
        try {
            ...
            buf.put( WTVMessageFactory.RECORDER_STOPGAMEDATA );
            buf.putShort( length );
            buf.putInt( gameId );
            buf.putInt( forceDelete );
            buf.flip( );
            return buf;
        } catch( Exception e )
        {
    ...
    {
        return "("+this.getClass( ).getName( )+": "+gameId+" "+forceDelete+")";
    }
}
