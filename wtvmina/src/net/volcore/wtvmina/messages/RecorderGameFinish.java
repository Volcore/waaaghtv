 ...
 *******************************************************************************/
public class RecorderGameFinish implements WTVMessage
{
    static Logger   logger = LoggerFactory.getLogger( "RecorderGameFinish" );
    ...
    public RecorderGameFinish( int gameId, int result )
    {
        this.gameId = gameId;
        this.result = result;
    }

    public RecorderGameFinish( IoBuffer in ) throws ParseException
    {
        try {
    ...
    public IoBuffer assemble( )
    {
        try {
            ...
            buf.put( WTVMessageFactory.RECORDER_GAMEFINISH );
            buf.putShort( length );
            buf.putInt( gameId );
            buf.putInt( result );
            buf.flip( );
