 ...
 *******************************************************************************/
public class RelayUnsubscribeGame implements WTVMessage
{
    static Logger   logger = LoggerFactory.getLogger( "RelayUnsubscribeGame" );
    ...
    public RelayUnsubscribeGame( int gameid ) throws ParseException
    {
        this.gameid = gameid;
    }

    public RelayUnsubscribeGame( IoBuffer in ) throws ParseException
    {
        gameid = in.getInt( );
    }
    ...
    public IoBuffer assemble( )
    {
        try {
            ...
            buf.put( WTVMessageFactory.RELAY_UNSUBSCRIBEGAME );
            buf.putShort( length );
            buf.putInt( gameid );
            buf.flip( );
            return buf;
